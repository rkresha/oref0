...
var setTempBasal = function (rate, duration, profile, rT, currenttemp) {
	...
	var dexcomMax = 6.35;
    // pre-fork from OpenAPS - var maxSafeBasal = Math.min(profile.max_basal, 3 * profile.max_daily_basal, 4 * basal);
	var maxSafeBasal = Math.min(profile.max_basal, dexcomMax);
